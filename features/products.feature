...
Background:
    Given the following Products
        | sku | name       | category | short_description | price | available | enabled | rating |
        | 001 | iPhone     | phone    | Apple iphone      | 100   | true      | false   | 5      |
        | 002 | MacBook    | computer | Apple laptop      | 200   | true      | true    | 4      |
        | 003 | Surface    | computer | Microsoft Laptop  | 300   | false     | true    | 4      |
